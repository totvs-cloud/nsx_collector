#!/usr/bin/env bash
# Instala e inicia o nsx-collector na máquina local (TESP04).
# Rodar como root na própria máquina.
set -euo pipefail
...
# ── Variáveis do site TESP04 ─────────────────────────────────────────────────
SITE_NAME="TESP4"
NSX_URL="https://10.103.29.200"
NSX_USER="admin"
NSX_PASS='nSxsp4T@!@dm!n#nsxT@2!'
...
echo ""
echo "==> Instalação concluída em TESP04 (${NSX_URL})."
