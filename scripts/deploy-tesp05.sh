#!/usr/bin/env bash
# Instala e inicia o nsx-collector na máquina local (TESP05).
...
# ── Variáveis do site TESP05 ─────────────────────────────────────────────────
SITE_NAME="TESP5"
NSX_URL="https://10.108.36.200"
NSX_USER="admin"
NSX_PASS='nSx--T@!@dm!n#nsxT@5!'
...
echo ""
echo "==> Instalação concluída em TESP05 (${NSX_URL})."
